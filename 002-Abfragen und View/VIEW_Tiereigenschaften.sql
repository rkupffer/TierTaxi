...
/****** Object:  View [dbo].[View_Tier-Eigenschaften]    Script Date: 28.05.2025 17:25:57 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT        dbo.tb_Tier.Tier, dbo.tb_Tierart.Tierart, dbo.tb_Tierart.Geschwindigkeit, dbo.tb_Tierart.Mitnahmegewicht, dbo.tb_Transportwege.Transportweg, dbo.tb_Standort.Standort
